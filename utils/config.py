...
def _expand_environment(value):
    """Expand local ${VAR} paths recursively without committing machine paths."""
...
def cfg_from_yaml_file(cfg_file):
    ...
    merge_new_config(config=config, new_config=_expand_environment(new_config))
    return config
